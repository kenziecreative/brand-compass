...
Read `workspace/STATE.md`. Phase 1 must be complete. If not:

"Phase 1 (Origin & Belief) needs to be completed first. Your core belief informs who you serve. Run `/brand-compass:phase-1-origin` to begin."

Stop.

If Phase 2 is already complete, say: "Phase 2 is already complete. Run `/brand-compass:phase-3-positioning` to continue." and stop.
...
When the Research Analyst completes, read `workspace/research/competitive-brief.md` and share:
...
- Connect audience back to core belief — "Given that you believe [X], who needs to hear that most?"
