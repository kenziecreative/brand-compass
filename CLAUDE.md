...
Discovery questions, agent protocols, completion criteria, and step-by-step facilitation guides for each phase live in the skill files — they are the single source of truth:

| Phase | Skill File |
|-------|-----------|
| 0 — Onboarding | `.claude/skills/brand-compass/start/SKILL.md` |
| 1 — Origin & Belief | `.claude/skills/brand-compass/phase-1-origin/SKILL.md` |
| 2 — Audience | `.claude/skills/brand-compass/phase-2-audience/SKILL.md` |
| 3 — Positioning | `.claude/skills/brand-compass/phase-3-positioning/SKILL.md` |
| 4 — Personality | `.claude/skills/brand-compass/phase-4-personality/SKILL.md` |
| 5 — Messaging | `.claude/skills/brand-compass/phase-5-messaging/SKILL.md` |
| 6 — Voice | `.claude/skills/brand-compass/phase-6-voice/SKILL.md` |
| 7 — Visual Identity | `.claude/skills/brand-compass/phase-7-visual/SKILL.md` |
| 8 — Toolkit Assembly | `.claude/skills/brand-compass/phase-8-toolkit/SKILL.md` |
| Checkpoint A | `.claude/skills/brand-compass/checkpoint-a/SKILL.md` |
| Checkpoint B | `.claude/skills/brand-compass/checkpoint-b/SKILL.md` |

When you need phase details outside of a skill invocation, read the relevant skill file directly. Do not rely on memory or summarization — the skill file is authoritative.
